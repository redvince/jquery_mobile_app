var ExitView2 = new MAF.Class({
	...
	createView: function () {
		...
		this.elements.noButton = new MAF.control.BackButton({
			styles:{
				width: 400,
				height: 75,
		...
		this.elements.mainMenuButton = new MAF.element.Button({
			styles:{
				width: 400,
				height: 75,
				backgroundImage: 'Images/Exit/Mainmenu_Button.png',
				vOffset: (this.elements.dialogueButton.outerHeight + 15),
				hAlign: "center"
			},
			events:{
				onSelect: function(){
